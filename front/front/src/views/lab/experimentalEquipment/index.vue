            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="设备名称" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="laboratoryId">
                        <Select v-model="searchForm.laboratoryId" placeholder="所属实验室" clearable style="width: 150px">
...
<script>
import {
    getExperimentalEquipmentList,
    deleteExperimentalEquipment,
    getLaboratoryList
} from "./api.js";
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getExperimentalEquipmentList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
