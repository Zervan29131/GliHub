<template>
   <div class="app-container">
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
         <el-form-item label="安全条例" prop="noticeTitle">
            <el-input v-model="queryParams.noticeTitle" placeholder="请输入安全条例" clearable @keyup.enter="handleQuery" />
         </el-form-item>
      ...
      <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="安全条例" align="center" prop="noticeTitle" :show-overflow-tooltip="true" />
      ...
      <el-dialog :title="title" v-model="open" width="780px" append-to-body>
         <el-form ref="noticeRef" :model="form" :rules="rules" label-width="80px">
            <el-row>
               <el-col :span="12">
                  <el-form-item label="安全条例" prop="noticeTitle">
                     <el-input v-model="form.noticeTitle" placeholder="请输入安全条例" />
                  </el-form-item>
               </el-col>
               <el-col :span="12">
                  <el-form-item label="类型" prop="noticeType">
...
const data = reactive({
   ...
   rules: {
      noticeTitle: [{ required: true, message: "安全条例标题不能为空", trigger: "blur" }],
      noticeType: [{ required: true, message: "安全条例类型不能为空", trigger: "change" }]
   },
});
...
function handleDelete(row) {
   ...
   proxy.$modal.confirm('是否确认删除安全条例编号为"' + noticeIds + '"的数据项？').then(function () {
