<template>
  <div class="app-container">
    ...
    <div>
      ...
      <el-upload class="upload-demo" drag :limit="1" :show-file-list="true" action="http://localhost:5000/upload/pic/"
        multiple :on-success="upload">
    ...
    <div class="pagination">
      <el-pagination background layout="total, sizes, prev, pager, next, jumper" v-model:current-page="query.curPage"
        v-model:page-size="query.pageSize" :page-sizes="[5, 10, 20]" :total="pageTotal"
