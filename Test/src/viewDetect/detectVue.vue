  ...
  <div class="container">
      ...
      <el-form ref="formRef" :model="AddModelForm" label-width="80px" :rules="rules">
        ...
        <el-form-item label="上传文件" label-width="150px">
          <el-upload class="upload-demo" drag :limit="1" :show-file-list="true"
            action="http://localhost:5000/upload/model/" multiple :on-success="handleUploadCache">
    ...
    <div>
      ...
      <el-descriptions :column="3" border title="检测模型">
        <el-descriptions-item label="模型ID" label-align="right" align="center" label-class-name="my-label"
...
<!-- 操作 -->
        <el-table-column label="操作" width="300" align="center">
          <template #default="scope">
            ...
            <!--              查看-->
            <!--            </el-button>-->
            <el-button text :icon="TopLeft" class="primary" @click="handleModelChoose(scope.$index, scope.row)"
              v-permiss="15">
              选中
            </el-button>
      ...
      <div class="pagination">
        <el-pagination background layout="total, sizes, prev, pager, next, jumper"
          v-model:current-page="model_query.curPage" v-model:page-size="model_query.pageSize" :page-sizes="[5, 10]"
          :total="modelTotal" @current-change="handleModelPageChange"
          @size-change="handleModelSizeChange"></el-pagination>
      </div>
    </div>
