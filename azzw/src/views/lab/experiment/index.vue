            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="实验名称" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="about">
                        <Input type="text" v-model="searchForm.about" placeholder="实验介绍" clearable style="width: 150px" />
                    </Form-item>
...
export default {
                    ...
                    render: (h, params) => {
                        if (params.row.fileUrl != undefined && params.row.fileUrl != "") {
                            return h("img", {
                                ...
                                on: {
                                    click: () => {
                                        windows.open(params.row.fileUrl + "?preview=true");
                                    },
                                },
                            });
                        } else {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getExperimentList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
