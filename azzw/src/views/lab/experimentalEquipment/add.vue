    ...
    <Card>
        <div slot="title">
            <div class="edit-head">
                ...
                <div class="head-name">添加实验设备</div>
                <span></span>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <FormItem label="生产日期" prop="productionDate">
                <DatePicker type="date" format="yyyy-MM-dd" @on-change="changeProductionDate" clearable placeholder="请选择生产日期..." style="width:570px"></DatePicker>
            </FormItem>
    ...
    methods: {
        ...
        handleSubmit() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    addExperimentalEquipment(this.form).then(res => {
